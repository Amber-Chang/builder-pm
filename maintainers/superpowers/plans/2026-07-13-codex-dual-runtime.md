...
- `maintainers/design.md`：更新雙執行環境決策與實作狀態。
...
- [ ] **Step 6: Update `maintainers/design.md` implementation status**
...
```bash
git add README.md template/ONBOARDING.md template/SKILLS.md maintainers/design.md setup.test.cjs
...
```bash
git add setup.sh setup.test.cjs README.md maintainers/design.md template/AGENTS.md template/.agents/skills template/ONBOARDING.md template/SKILLS.md
